  ...
  methods: {
    createSociety() {
      if (this.newSocietyName) {
        axios.post('https://ss-calendar.herokuapp.com/user', null,
    ...
    deleteSociety() {
      if (this.societyToDelete) {
        axios.delete('https://ss-calendar.herokuapp.com/society',
    ...
    getSocietyAvailability(society) {
      axios.get('https://ss-calendar.herokuapp.com/society',
    ...
    leaveSociety() {
      if (this.societyToLeave) {
        axios.delete('https://ss-calendar.herokuapp.com/user',
